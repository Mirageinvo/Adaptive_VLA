...
даёт `dZ = 0` ТОЧНО. На этом держится тождество HiCoRA-T с fast12 при нулевой
инициализации последнего слоя (именно с fast12: черновик снимается головой
Joint12 на 12-м слое, а coarse24 — это generate на 24 слоя). Центрированный
базис тождества сам по себе не нарушает — он задаёт ДРУГОЕ подпространство,
то есть другой эксперимент.
