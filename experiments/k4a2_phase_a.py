...
baseline занижен разбавлением по шестнадцати ячейкам. Строка
«случайно среди изменённых» ниже даёт честное сравнение.""")
...
разрыва почти не меняет действие, и вся линия имеет низкий потолок.""")
    ...
    names = {"exact": "точный <=4", "greedy": "жадный послед.",
             ...
             "random": "случайно из 16", "random_chg": "случ. среди изменённых"}
