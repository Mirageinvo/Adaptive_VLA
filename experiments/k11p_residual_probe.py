...
def selftest():
    ...
    print("самопроверка k11p пройдена (версия «нуль в сетке штрафа»): "
          ...
          "отвергают подмену нормы, отвода, meta и массивов, нуль в сетке "
          "штрафа стоит первым и вычисляется даже на вырожденной системе, а "
          "собранный конвейер находит заложенную связь и НЕ находит её там, "
          "где её нет")
