...
def make_trajectory_head():
    ...
    class TrajectoryHead(nn.Module):
        ...
        def __init__(self, d_hidden, d_latent, n_pos=N_POS_DEFAULT,
            ...
            # строго нулевая, и HiCoRA-T в начальной точке ТОЧНО совпадает с
            # coarse24. Это тождество проверяется в пространстве действий.
...
def selftest():
    ...
    # то есть Z_T = Z_0 и действия совпадают с coarse24 бит в бит.
