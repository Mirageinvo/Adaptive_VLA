...
CKPT_DIR="${CKPT_DIR:-/mnt/dataset/dzb/vq_checkpoints/smolvlm_all_2b_pd/random_pos_ids/20k/}"
...
CFG_PATH="${CFG_PATH:-config/eval/pd.yaml}"
...
# Hard-coded pos_offset values for each task
# Format: POS_OFFSET_<SUITE>_<TASK_ID>

# Goal suite pos_offset
POS_OFFSET_GOAL=(4 4 4 4 4 3 4 4 4 4)

# Spatial suite pos_offset
POS_OFFSET_SPATIAL=(4 4 4 4 4 4 4 4 4 3)

# Object suite pos_offset
POS_OFFSET_OBJECT=(4 4 4 2 4 4 4 4 4 4)

# Long (14) suite pos_offset
POS_OFFSET_LONG=(4 4 3 4 2 4 4 4 4 4)
