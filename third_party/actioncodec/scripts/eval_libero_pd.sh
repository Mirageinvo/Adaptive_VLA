...
CKPT_DIR="${CKPT_DIR:-ZibinDong/SmolVLM2-2.2B-ActionCodec-PD-LIBERO}"
DEVICE="${DEVICE:-cuda:0}"
IMG_AUG="${IMG_AUG:-True}"
TILED_IMG="${TILED_IMG:-True}"
ENSEMBLE="${ENSEMBLE:-True}"
HORIZON="${HORIZON:-4}"
OUTPUT_DIR="${OUTPUT_DIR:-./evaluation/pd/}"
...
POS_OFFSET_GOAL=(4 4 4 3 4 3 4 4 4 4)

# Spatial suite pos_offset
POS_OFFSET_SPATIAL=(4 4 4 4 4 4 4 4 3 4)

# Object suite pos_offset
POS_OFFSET_OBJECT=(4 4 4 4 4 4 4 4 4 4)

# Long suite pos_offset
POS_OFFSET_LONG=(4 4 3 4 4 4 4 4 4 4)
